...
if (referral1_id != "undefined"){
 if (referral1_stat == "partner1"){
  ...
  balanceRef.add(160);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral1_id, "🏧 Вам начислен доход с первой линии : +160.0 $");
...
if (referral2_id != "undefined"){
 if (referral2_stat == "partner2"){
  ...
  balanceRef.add(80);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral2_id, "🏧 Вам начислен доход со второй линии : +80.0 $");
 }
}
...
if (referral3_id != "undefined"){
 if (referral3_stat == "partner3"){
  ...
  balanceRef.add(40);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral3_id, "🏧 Вам начислен доход с третьей линии : +40.0 $");
 }
}
...
if (referral4_id != "undefined"){
 if (referral4_stat == "partner3"){
  ...
  balanceRef.add(20);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral4_id, "🏧 Вам начислен доход с четвёртой линии : +20.0 $");
 }
}
...
if (referral5_id != "undefined"){
 if (referral5_stat == "partner3"){
  ...
  balanceRef.add(20);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral5_id, "🏧 Вам начислен доход с пятой линии : +20.0 $");
 }
}
}
