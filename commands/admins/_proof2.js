...
if (referral3_id != "undefined"){
 if (referral3_stat == "partner3"){
  ...
  balanceRef.add(20);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral3_id, "🏧 Вам начислен доход с третьей линии : +20.0 $");
 }
}
...
if (referral4_id != "undefined"){
 if (referral4_stat == "partner3"){
  ...
  balanceRef.add(10);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral4_id, "🏧 Вам начислен доход с четвёртой линии : +10.0 $");
 }
}
...
if (referral5_id != "undefined"){
 if (referral5_stat == "partner3"){
  ...
  balanceRef.add(10);
  balanceCount.add(1);
  Bot.sendMessageToChatWithId(referral5_id, "🏧 Вам начислен доход с пятой линии : +10.0 $");
 }
}
}
